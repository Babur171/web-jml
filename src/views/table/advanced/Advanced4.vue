      ...
      <div class="-mx-6">
        ...
        >
          <template v-slot:table-row="props">
            ...
            <span v-if="props.column.field == 'pdfDocument'">
              <div class="flex justify-center items-center h-full">
                <Tooltip placement="top" arrow theme="dark">
                  <template #button>
                    <div class="flex items-center space-x-2" @click="redirectToPdf(props.row.pdfUrl)">
                      <span>Pdf</span>
                      <Icon icon="heroicons:eye" class="w-5 h-5 ml-2 mt-1" />
                    </div>
                  </template>
                  <span> View Pdf</span>
                </Tooltip>
